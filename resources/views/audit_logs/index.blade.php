<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <form method="POST" action="{{ route('audit.logs.clear') }}" class="inline">
                @csrf
    ...
    <div class="py-10">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('audit.logs.index') }}" class="mb-4 bg-white shadow-md rounded-xl p-4">
                <div class="flex flex-wrap gap-2">
                    <input type="text" name="search" value="{{ request('search') }}"
                           placeholder="Search logs..."
                           class="border border-gray-300 rounded-lg px-4 py-2 w-full md:w-auto">

                    <select name="event" class="border border-gray-300 rounded-lg px-4 py-2">
                    ...
                    <a href="{{ route('audit.logs.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
                        Reset
                    </a>
                </div>
            </form>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-100 text-gray-600 uppercase text-xs">
                            <tr>
                                ...
                                <th class="p-4 text-left">Auditable</th>
                        ...
                        <tbody class="divide-y">
                            @forelse($logs as $log)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="p-4 text-gray-600 text-xs">{{ Str::limit($log->url, 40) }}</td>
